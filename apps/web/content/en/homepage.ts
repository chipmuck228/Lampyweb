...
export const enHomepage: HomepageContent = {
  ...
  family: {
    ...
    body: "Keep entries for yourself, or share selected moments with your family. Lampy is not a public feed.",
    from: "Hangzhou · a voice after dinner",
    to: "Vancouver · heard again in the morning",
    relationAria: "A private distance, not a delivery status",
  ...
  downloads: {
    ...
    iosPending: "Coming to iOS",
    androidPending: "Coming to Android",
    iosPendingNote: null,
    androidPendingNote: null,
  },
  footer: {
    brand: "Lampy",
